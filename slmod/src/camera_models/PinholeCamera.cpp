...
PinholeCamera::Parameters::Parameters(int w, int h, int equalize,
                                      double k1, double k2,
                                      double p1, double p2,
                                      double fx, double fy,
                                      double cx, double cy)
...
int&
PinholeCamera::Parameters::imageWidth(void)
{
    return m_imageWidth;
}

int&
PinholeCamera::Parameters::imageHeight(void)
{
    return m_imageHeight;
}

int&
PinholeCamera::Parameters::equalize(void)
{
    return EQUALIZE;
}

int
PinholeCamera::Parameters::imageWidth(void) const
{
    return m_imageWidth;
}

int
PinholeCamera::Parameters::imageHeight(void) const
{
    return m_imageHeight;
}

int
PinholeCamera::Parameters::equalize(void) const
{
    return EQUALIZE;
}

int
PinholeCamera::Parameters::nIntrinsics(void) const
{
...
//     out << "   image_width " << params.imageWidth() << std::endl;
//     out << "  image_height " << params.imageHeight() << std::endl;

//     // radial distortion: k1, k2
//     // tangential distortion: p1, p2
//     out << "Distortion Parameters" << std::endl;
//     out << "            k1 " << params.k1() << std::endl
//         << "            k2 " << params.k2() << std::endl
//         << "            p1 " << params.p1() << std::endl
//         << "            p2 " << params.p2() << std::endl;

//     // projection: fx, fy, cx, cy
//     out << "Projection Parameters" << std::endl;
//     out << "            fx " << params.fx() << std::endl
//         << "            fy " << params.fy() << std::endl
//         << "            cx " << params.cx() << std::endl
//         << "            cy " << params.cy() << std::endl;
